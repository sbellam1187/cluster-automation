...
# argocd to replace TEMPLATE_VAR_PUBLIC_SUBNET_ID with a comma-separated list of
# public subnet IDs for the istio-gateway ELB (for example in the aws-load-balancer-subnets annotation).
