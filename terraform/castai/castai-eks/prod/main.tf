...
module "castai_config" {
  source                           = "git::https://github.com/AAInternal/runway-kubernetes-cluster-automation//terraform/__modules/castai/castai-configuration?ref=v1.1.1-tf-castai-config%2Bpr7579"
